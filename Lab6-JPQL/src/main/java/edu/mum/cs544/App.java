...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<Airline> airlines = em.createQuery(" select distinct a from Airline a left join a.flights as f where f.airplane.model = 'A380'", Airline.class).getResultList();
        ...
        flights = em.createQuery("from Flight f where f.airplane = '747' and f.airline <> 'Star Alliance'", Flight.class).getResultList();
        System.out.printf("%-9s%-31s%-31s\n", "Flight:", "Departs:",
                "Arrives:");
        for (Flight flight : flights) {
            System.out.printf("%-7s  %-12s %7s %8s  %-12s %7s %8s\n",
       ...
       calendar.set(2009, 8,07);
       query.setParameter("date",calendar, TemporalType.DATE);
